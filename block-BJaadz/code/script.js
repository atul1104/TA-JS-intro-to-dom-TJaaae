...
allHrsArray.forEach(
  (element) => (element.style.backgroundColor = "antiquewhite")
);
...
document
  ...
  .forEach((element) => (element.style.border = `2px solid purple`));
...
para2 = "Append inserts as last child";
box2.append(para2);
...
para3 = "Prepend inserts as last child";
box3.prepend(para3);
...
allBoxes.forEach((element, index) => {
  if ((index + 1) % 2 !== 0) {
    return (element.style.backgroundColor = "aliceblue");
  }
});
...
box9.append(btn);
// Create a img element with src value `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR63lEyJerJUsVkakjluH_4Iex5LPMkJrkpPw&usqp=CAU` and store in a variable named imgElm
let imgElm = document.createElement("img");
imgElm.src = `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR63lEyJerJUsVkakjluH_4Iex5LPMkJrkpPw&usqp=CAU`;
