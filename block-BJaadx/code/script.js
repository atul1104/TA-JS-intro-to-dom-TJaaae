...
let liNumber = document.body.children[5].childElementCount;
console.log(`length of li is ${liNumber}`);
...
allTopics.forEach((element) => console.log(element.innerHTML));
...
console.log(`The total number of buttons are ${allBtn.length}`);
// 18. Select all the `label` element and log the count.
let allLabels = document.querySelectorAll("label");
console.log(`The total number of labels are ${allLabels.length}`);
...
let parentEle = fieldsetElm.parentElement;
console.log(typeof parentEle);
